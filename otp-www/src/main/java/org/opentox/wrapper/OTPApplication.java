...
public class OTPApplication extends TaskApplication<String> {

	public OTPApplication() {
		super();
		setName("OpenTox Prediction service wrapper");
		setDescription("OpenTox Prediction service wrapper");
		...
		setStatusService(new OTPRESTStatusService());
		setTunnelService(new TunnelService(true, true) {
			@Override
			public Filter createInboundFilter(Context context) {
				return new OTPRESTTunnelFilter(context);
			}
		});
	...
	public Restlet createInboundRoot() {
		...
		OTPApplication.printRoutes(router, ">", w);
	...
	protected TaskStorage<String> createTaskStorage() {
		return new TaskStorage<String>(getName(), getLogger()) {
			@Override
			protected ITask<ITaskResult, String> createTask(String user, ICallableTask callable) {
	...
	public static void main(String[] args) throws Exception {
		...
		// Create a component
		Component component = new OTPRESTComponent();
