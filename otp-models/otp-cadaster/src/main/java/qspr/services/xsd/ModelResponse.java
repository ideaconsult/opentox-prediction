...
public class ModelResponse  implements java.io.Serializable {
     ...
     * @return predictions
     */
    public qspr.services.xsd.Prediction[] getPredictions() {
        return predictions;
    }
     ...
     * @param predictions
     */
    public void setPredictions(qspr.services.xsd.Prediction[] predictions) {
        this.predictions = predictions;
    }

    public qspr.services.xsd.Prediction getPredictions(int i) {
        return this.predictions[i];
    }

    public void setPredictions(int i, qspr.services.xsd.Prediction _value) {
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://services.qspr/xsd", "Prediction"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
